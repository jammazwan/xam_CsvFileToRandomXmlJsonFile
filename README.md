...
Git clone the xam_CsvFileToRandomXmlJsonFile project into your workspace:
...
cd xam_CsvFileToRandomXmlJsonFile
mvn install -DskipTests

```

You man now import xam_CsvFileToRandomXmlJsonFile into your IDE.
